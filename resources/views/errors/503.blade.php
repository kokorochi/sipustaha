...
<!-- START @META  SECTION -->
    ...
    <title>Maintenance | SIPUSTAHA - Error 503</title>
    <!--/ END META SECTION -->
...
<!-- START @THEME  STYLES -->
    ...
    <link href="{{url('assets/css/themes/laravel.theme.css')}}" rel="stylesheet">
    <link href="{{url('assets/css/themes/cyan.theme.css')}}" rel="stylesheet">
    <link href="{{url('assets/css/custom.css')}}" rel="stylesheet">
    <link href="{{url('assets/css/pages/error-page.css')}}" rel="stylesheet">
    <!--/ END THEME STYLES -->
...
<div class="error-wrapper">
    <h1>503</h1>
    <h3>Website sedang di-maintenance</h3>
    <h3>Akan segera online kembali.</h3>
    <br>
    <p>Hubungi PSI untuk informasi lebih lanjut.</p>
</div>
