...
<head>
    ...
    <title>SIPUSTAHA USU - Landing Page</title>
...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand" href="#page-top">SIPUSTAHA</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="page-scroll">
                    <a href="#about">Tentang SIPUSTAHA</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="intro-text">
                    <h1 class="name">SIPUSTAHA</h1>
                    <hr class="star-light">
                    <span class="skills">Sistem Informasi Manajemen Publikasi, Paten, dan HKI</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2>Tentang SIPUSTAHA</h2>
                <hr class="star-primary">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 col-lg-offset-2">
                <p>SIPUSTAHA merupakan sistem informasi yang dirancang untuk memudahkan dosen dalam menyimpan data-data publikasi, paten, dan HKI</p>
            </div>
            <div class="col-lg-4">
                <p>Untuk dapat menggunakan SIPUSTAHA, dosen harus melakukan login terlebih dahulu. Silahkan klik tombol login di bawah untuk melakukan login.</p>
            </div>
