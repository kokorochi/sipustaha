<div id="journal-container" class="detail-container">
    ...
    @include('layout.input-upload', ['passing_variable' => 'file_name_ori', 'passing_description' => 'Unggah File(Cover Jurnal, Daftar Isi, Halaman Artikel Jurnal yang bersangkutan, Acceptance Letter)'])
