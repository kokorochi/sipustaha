<div id="proceeding-container" class="detail-container">
    ...
    @include('layout.input-upload', ['passing_variable' => 'file_name_ori', 'passing_description' => 'Unggah File(Cover, Daftar Isi, Halaman Artikel Prosiding yang bersangkutan, Sertifikat Pemakalah, Acceptance Letter)'])
