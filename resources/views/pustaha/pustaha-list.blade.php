            ...
            <div class="panel rounded shadow">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-left">
                                <a href="{{url('pustahas/create')}}" class="btn btn-theme rounded"
                                   data-toggle="tooltip" data-placement="top" title="Tambah">
                                    <i class="fa fa-plus"></i> Tambah Pustaha
                                </a>
                            </div>
                            <div class="clearfix"></div>
                            <hr>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive mb-20">
                                <table id="pustaha-list" class="table table-striped table-theme">
                                    <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>No.</th>
