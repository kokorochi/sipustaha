                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{url($action_url)}}" method="post">
                                ...
                                <div id="user-auth-table" class="form-group table-responsive user-auth-table">
                                    <table class="table">
                                        <thead>
                                            ...
                                            <tr class="text-center">
                                                <td>
                                                    <select name="auth_type[]" type="text" class="form-control select2">
                                                        <option value="OWR3" {{$item['auth_type'] == 'OWR3' ? 'selected' : null}}>Operator WR3</option>
                                                        <option value="OPEL" {{$item['auth_type'] == 'OPEL' ? 'selected' : null}}>Operator Lembaga Penelitian</option>
                                                    </select>
                                                </td>
                                                <td>
                                        ...
                                        <tr class="hide text-center">
                                            <td>
                                                <select name="auth_type[]" type="text" class="form-control" value=""
                                                        disabled>
                                                    <option value="OWR3">Operator WR3</option>
                                                    <option value="OPEL">Operator Lembaga Penelitian</option>
                                                </select>
                                            </td>
                                            <td>
