...
Route::get('pustahas/diseminasi', 'PustahaController@diseminasi');
Route::post('pustahas/diseminasi', 'PustahaController@diseminasiStore');
Route::get('diseminasi/edit', 'PustahaController@diseminasiEdit');
Route::get('diseminasi/download-document', 'PustahaController@diseminasiDownload');
Route::get('pustahas/insentif', 'PustahaController@insentif');
Route::post('pustahas/insentif', 'PustahaController@insentifStore');
